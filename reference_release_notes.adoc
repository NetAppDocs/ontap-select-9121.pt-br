...
Pode aceder ao https://library.netapp.com/ecm/ecm_download_file/ECMLP2884847["Notas de versão do ONTAP Select 9.12.1"^] para visualizar os detalhes sobre a versão atual.
